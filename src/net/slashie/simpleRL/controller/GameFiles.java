...
public class GameFiles {
	...
	public static void saveMemorialFile(Player player){
		try{
			...
			SimpleRL.crash("Error writing the memorial file", ioe);
		}
		
	}
	
	public static void saveGame(SimpleRL g, Player p){
		...
		try {
			...
			SimpleRL.crash("Error saving the game", ioe);
		}
	}
	...
	public static void saveChardump(Player player){
		try{
			...
			SimpleRL.crash("Error writing the chardump", ioe);
		}
	}
