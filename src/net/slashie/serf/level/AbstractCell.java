...
public abstract class AbstractCell implements Cloneable, java.io.Serializable{
	...
	public AbstractCell (String pID, String pShortDescription, String pDescription, Appearance pApp){
		ID = pID;
		appearance = pApp;
	...
	public AbstractCell (String pID, String sdes, String pDescription, Appearance pApp, boolean isSolid, boolean isOpaque){
