...
public class SwingSystemInterfaceActiveRendering extends SwingSystemInterface { 
	...
	public SwingSystemInterfaceActiveRendering (){
		this(false, 800, 600);
	}
	
	public SwingSystemInterfaceActiveRendering (boolean fullScreen, int screenWidth, int screenHeight){
		this(1, fullScreen, screenWidth, screenHeight);
	}
	
	public SwingSystemInterfaceActiveRendering (int layers, boolean fullScreen, int screenWidth, int screenHeight){
		this (layers, fullScreen, screenWidth, screenHeight, 20);
	}
	
	public SwingSystemInterfaceActiveRendering (int layers, boolean fullScreen, final int screenWidth, int screenHeight, int fps){
		...
		inputQueueKeyListener = new CallbackKeyListener<Integer>(inputQueue){
			...
			public void keyPressed(KeyEvent e) {
				try {
					handler.put(SwingSystemInterfaceActiveRendering.charCode(e));
	...
	public void waitKeysOrClick(final int... keyCodes) {
		...
		CallbackKeyListener<String> cbkl = new CallbackKeyListener<String>(waitKeyOrClickHandler){
			...
			public void keyPressed(KeyEvent e) {
				try {
					int pressed = SwingSystemInterfaceActiveRendering.charCode(e);
					for (int keyCode: keyCodes){
						if (pressed == keyCode){
							handler.put("OK");
							return;
