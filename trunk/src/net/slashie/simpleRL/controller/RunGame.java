...
import net.slashie.simpleRL.action.player.Walk;
import net.slashie.simpleRL.data.dao.EntitiesDAO;
import net.slashie.simpleRL.ui.Display;
import net.slashie.simpleRL.ui.console.CharDisplay;
import net.slashie.simpleRL.ui.console.CharEffects;
import net.slashie.simpleRL.ui.console.CharSimpleRLUserInterface;
...
public class RunGame {
	...
	private static void init(){
		if (createNew){
			System.out.println("SimpleRL "+GameInfo.getVersion());
            ...
            try {
				...
				case SWING_CONSOLE:
					...
					csi = null;
					csi = new WSwingConsoleInterface("SimpleRL - An example for the SERF Engine");
				}
				
				if (isConsole){
					System.out.println("Initializing Console User Interface");
					UserInterface.setSingleton(new CharSimpleRLUserInterface(csi));
	...
	private static void loadGame(){
		...
		try {
			...
			currentGame = (SimpleRL) ois.readObject();
			ois.close();
	...
	private static void initializeUI(Object si){
		...
		Action bolt = new Walk();
		UserAction[] userActions = new UserAction[] {
		    new UserAction(bolt, CharKey.b)
		};
	...
	public static void main(String args[]){
		...
		try {
			...
			SimpleRL.crash("Unrecoverable Exception [Press Space]",e);
